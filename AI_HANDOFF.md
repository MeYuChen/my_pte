...
3. 在速记模式内显示分类筛选、母逻辑、中文钩子和写作逻辑，帮助用户按主题快速串联记忆。

速记模式的数据来源：

- 图片源目录：`D:\Downloads\WE_Bplus_39_cards_final_v3`
- 分类表来源：`D:\Downloads\PTE_WE_39篇分类背诵总表.md`

分类只服务速记模式，不要全局影响模板练习、文章论点练习、考核模式。当前速记筛选包括：全部、第一轮高频迁移、第二轮场景强化、第三轮专项补强、教育学习、科技媒体、工作公司、政府法律、环境气候、城市公共、个人家庭、正反平衡题。
